...
public class Settings {
	public static final String BASE_URL = "http://52.165.145.168:8084/";
	...
	public static final String AUTHORIZE_URL = BASE_URL + "oauth2provider/oauth2/auth";
	public static final String ACCES_TOKEN_URL = BASE_URL + "oauth2provider/oauth2/token";
	public static final String RESPONSE_TYPE = "code";
	public static final String REDIRECT_URI = "https://layla.amazon.com/api/skill/link/M2B5RLVJ186581";

	public static final String PERSONAL_INFO_URL = BASE_URL + "oauth2provider/resource/myinfo.do";
	...
	public static String getParamString(HashMap<String, String> map, boolean useAuthHeader) throws Exception {
		...
		for (String key : map.keySet()) {
			if (useAuthHeader == true && (key.equals("client_id") || key.equals("client_secret"))) {
				continue;
			}
			if (i != 0)
				strout += "&";
